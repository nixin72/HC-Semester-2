...
var firstRoll = function() {
	...
	document.getElementById("firstDiceRoll").textContent = roll1;
	document.getElementById("die1").textContent = outcome1;
	return roll1;
}
...
var secondRoll = function() {
	...
	document.getElementById("secondDiceRoll").textContent = roll2;
	document.getElementById("die2").textContent = outcome2;
	return roll2;
}
...
var thirdRoll = function() {
	...
	document.getElementById("thirdDiceRoll").textContent = roll3;
	document.getElementById("die3").textContent = outcome3;
	return roll3;
}
